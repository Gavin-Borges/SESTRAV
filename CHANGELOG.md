...
- **PII & absolute path gatekeeper**: Added a pre-merge action workflow (`.github/workflows/pii_scan.yml`) to block commits containing machine-specific filesystem path leaks (e.g. `C:\Users\...` or `/mnt/c/`) or unresolved TODO placeholders.
