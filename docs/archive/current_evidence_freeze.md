...
- Active freeze snapshot: `docs/history/colloquium_evidence_freeze_v2_20260524.md`
- Latest publish-gate decision: `docs/history/final_publish_gate_report_20260524.md`
- Historical freeze cycle record: `docs/history/reproducibility_finalization_status.md` (2026-04-25 context)
