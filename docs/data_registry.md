...
| `eval_tsnadb_crossdomain.py` | `results/tsnadb_crossdomain_benchmark.json` | 9,903 pool (4,998 pos / 4,905 neg) | canonical-10. **Metrics retracted 2026-08-12 (D24-class); see AD-4.** |
