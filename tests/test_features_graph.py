...
class TestGetCbCbEdges:
    ...
    def test_10mer_has_correct_bulge_contacts(self):
        ...
        assert (3, 6) in edges
        assert (4, 7) in edges
        assert (3, 8) not in edges, (
            "10-mer should not have 9-mer (3,7) or 11-mer (3,7)-style contacts"
        )
...
class TestComputeErapTrimmingScore:
    ...
    def test_flanking_seq_3plus_uses_last_3(self):
        ...
        assert score_long == pytest.approx(score_short), "Only last 3 chars of flanking_seq matter"
