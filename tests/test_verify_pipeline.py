...
def test_clean_and_pool_epitopes():
    records = [
        {"linear_sequence": "GLFYTRTGL", "mhc_allele_name": "HLA-A*02:01", "qualitative_measure": "Positive", "source_molecule": "Spike"},
        {"linear_sequence": "GLFYTRTGL", "mhc_allele_name": "HLA-A*02:01", "qualitative_measure": "Positive", "source_molecule": "Spike"},
        {"linear_sequence": "GLFYTRTGL", "mhc_allele_name": "HLA-A*02:01", "qualitative_measure": "Negative", "source_molecule": "Spike"}, # Conflict resolved to Positive (mean = 2/3 >= 0.5)
        {"linear_sequence": "AAYSDQWAL", "mhc_allele_name": "HLA-A*24:02", "qualitative_measure": "Negative", "source_molecule": "Membrane"},
        {"linear_sequence": "INVALIDPEPTIDE", "mhc_allele_name": "HLA-A*02:01", "qualitative_measure": "Positive"}
    ]
