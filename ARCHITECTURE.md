...
| 4. Immunogenicity scoring | Features + serialized model | RF / XGBoost ensemble; SHAP attribution; isotonic calibration + tuned threshold. **No conformal intervals** - claimed here until 2026-09-07, never implemented, RETRACTED | `{proteome}_ranked.csv` |
