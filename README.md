...
|------|--------|---------|------------|
| **SESTRAV RF (`full_31`/`mode_31`, canonical)** | **0.828** | 0.843 | OOF 5-fold, ungrouped (leakage-inflated, D15) |
