...
def write_fairness_report(
    ...
    lines = [
        ...
        "",
        "SESTRAV RF uses 5-fold out-of-fold predictions. PredIG and PRIME use",
        "fully-trained models that may have seen evaluation peptides during their",
        "own IEDB-based training. This asymmetry does NOT handicap SESTRAV: the",
        "folds are stratified but not grouped by peptide, so 71.0% of held-out rows",
        "share their exact peptide with the training fold and the out-of-fold arm is",
        "optimistic, not conservative (docs/claims_register.md D15). Earlier versions",
        "of this report described the OOF arm as 'conservative'; that is withdrawn.",
        "",
