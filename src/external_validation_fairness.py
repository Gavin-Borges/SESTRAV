...
def write_fairness_report(
    ...
    lines = [
        ...
        "own IEDB-based training. Earlier versions of this report described the OOF",
        "arm as 'conservative' for this reason; that is withdrawn. It is not",
        "replaced with the opposite claim: this benchmark's 720-peptide corpus has",
