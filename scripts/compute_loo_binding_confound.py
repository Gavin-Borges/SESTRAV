...
Reproduce:  python scripts/compute_loo_binding_confound.py
Writes:     results/loo_binding_confound_decomposition.csv
"""
...
OUT = "results/loo_binding_confound_decomposition.csv"
...
def main() -> None:
    ...
    out = pd.concat([tab, pd.DataFrame([mean_row])], ignore_index=True)
